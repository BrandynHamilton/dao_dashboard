...
monthly_ev = historical_ev.resample('M').last()
...
date_fixed_income = monthly_stats['net_income'].resample('M').last()
...
threshold = 6000  # This is an example value; adjust it based on your analysis
