...
def enterprise_metrics():
    ...
    st.write("""Enterprise Value (EV) and Enterprise Value to Revenue (EV/R) ratios are key financial metrics that can offer insights into the valuation and performance of decentralized autonomous organizations (DAOs), similar to their use in evaluating traditional companies.  A rising EV/R might indicate increasing market optimism about the DAO's future growth prospects. Conversely, a decreasing ratio might suggest a market reevaluation of the DAO's potential.""")
    ...
    with st.expander('***Enterprise Value to Revenue (EV/R)***'):
        st.write("""This ratio compares the company's enterprise value to its revenue.
