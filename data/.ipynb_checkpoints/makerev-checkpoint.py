...
historical_ev = historical_ev.merge(filtered_income.to_frame('net_income'), left_index=True, right_index=True)

filtered_revenue = revenue[revenue.index >= '2020-12-31']

ev_metrics = historical_ev.merge(filtered_revenue.to_frame('revenue'), left_index=True, right_index=True)
